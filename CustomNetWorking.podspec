...
Pod::Spec.new do |spec|
  ...
  spec.description  = "AFNetWorking二次封装（数据请求、数据缓存、数据文件上传、数据文件下载、数据文件断点下载），支持自定义配置，支持YYCache进行数据缓存处理"
  ...
  # Or just: spec.author    = "Singularity_Lee"
  # spec.authors            = { "Singularity_Lee" => "496736912@qq.com" }
  # spec.social_media_url   = "https://twitter.com/Singularity_Lee"
